...
# set up environment
export PATH=${HOMEBREW_PREFIX}/opt/gdal-20/bin:${HOMEBREW_PREFIX}/bin:${HOMEBREW_PREFIX}/sbin:${PATH}
export PYTHONPATH=${HOMEBREW_PREFIX}/opt/gdal-20/lib/python2.7/site-packages:${HOMEBREW_PREFIX}/lib/python2.7/site-packages:${PYTHONPATH}
